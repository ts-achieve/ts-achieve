...
[`ts-achieve`](https://marketplace.visualstudio.com/items?itemName=ts-achieve.ts-achieve) is a VS Code extension by T.S. Achieve. It gamifies the TypeScript development experience by organizing diagnostic messages into unlockable achievements.
